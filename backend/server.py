...
CF_BYPASS_PREFIXES = ["/api/twilio", "/api/call", "/health", "/api/integrations/stripe/callback", "/api/calendar/google/callback", "/api/integrations/square/callback", "/api/webhooks/stripe"]
