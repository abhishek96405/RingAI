        ...
        <nav className="space-y-1">
          {navItems.map((item) => (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all ${isActive(item.path) ? "bg-coral/15 text-coral-deep" : "text-ink-soft hover:text-ink hover:bg-coral/5"}`}
            >
