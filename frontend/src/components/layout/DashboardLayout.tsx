...
const restaurantNavItems = [
  ...
  { icon: Brain, label: "AI Learning", path: "/dashboard/learning", proOnly: true },
];
        ...
        <nav className="space-y-1">
          {navItems.map((item) => (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all ${isActive(item.path) ? "bg-coral text-white shadow-[0_12px_24px_-10px_rgba(238,147,119,0.5)]" : "text-ink-soft hover:text-ink hover:bg-coral/5"}`}
            >
