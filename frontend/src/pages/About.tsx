...
const founders = [
  ...
  { name: "Nagashreya Dachepalli", role: "Co-founder and Marketing & Creative Lead", initials: "ND", photo: "/Shreya.jpeg", bio: "Co-founder and Marketing & Creative Lead at Duuutah AI, where she shapes the brand and how the product shows up in the world. She's drawn to the craft of it — the design, the visual identity, the small choices that make a brand feel like itself. That creative instinct is backed by years in data analytics, which left her with an analyst's eye for what's actually working and what just looks good. At Duuutah AI the two come together: she owns marketing and creative end to end, building a brand that's as considered in its numbers as it is in its look." },
];
