...
| PR-J | 🔧 | Performance & startup (J1 A1-3 get_current_user hot-path write eliminated ✔️ · J2 A2-8/A3-3 resolve_restaurant_access added + reservation & POS routes migrated 4→2 reads ✔️; ~11 remaining double-lookup routes tracked for opportunistic migration — see AUDIT_FINDINGS A2-8/A3-3 · J3 A5-6 fan-out / J4 A1-4 startup-migration ✔️ — @app.on_event("startup") removed; data no longer migrated on every boot (migrate_split_brain.py is the comprehensive one-off) / J5 A1-5+A1-7 next) | A1-3, A2-8/A3-3, A5-6, A1-4, A1-7, A1-5 |
