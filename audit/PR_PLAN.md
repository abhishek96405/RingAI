...
| PR-I | 🔧 | Booking-vertical reliability (scope: restaurants + salons only — clinic/home_services/legal dormant. I0 vertical-pruning ✔️ · I1 booking-dispatch reliability ✔️ — dispatch_appointment success reflects persistence + fire-and-forget operator alert on lost booking; I2 manual create/confirm parity next) | A3-2, B2-1, A8-7, B2-7, C17-1, C17-4, C18-2, C15-8 |
