...
| PR-I | 🔧 | Booking-vertical reliability (scope: restaurants + salons only — clinic/home_services/legal dormant. I0 vertical-pruning ✔️ merged; I1 booking-dispatch reliability next) | A3-2, B2-1, A8-7, B2-7, C17-1, C17-4, C18-2, C15-8 |
