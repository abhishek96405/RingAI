...
**Updated:** 2026-06-18 · `ringai-deploy` @ `7d6d8af` — PR-L ✔️ (landing page fully redesigned + fabricated-claims/rebrand cleanup merged); PR-M started (legal pages)
...
| PR-M | 🔧 | Legal pages — Privacy + Terms (Security folded into Privacy; GDPR dropped — US-only) (LAUNCH-GATING: Stripe live) | C35-1 |
